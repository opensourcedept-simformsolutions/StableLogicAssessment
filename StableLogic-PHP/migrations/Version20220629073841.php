 ...
 */
final class Version20220629073841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, continent_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, alpha_2_code VARCHAR(2) NOT NULL, currency_code VARCHAR(5) NOT NULL, INDEX continent_id (continent_id), INDEX FKcountry50845 (continent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
